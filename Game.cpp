...
void Game::CheckCollision()
{
	...
	if (bricks.empty())
	{
		...
		Console::WordWrap(WINDOW_WIDTH / 4, WINDOW_HEIGHT / 2, WINDOW_WIDTH, "You win! Press 'R' to play again.");
	}
	...
	if (ball.y_position >= WINDOW_HEIGHT - 1)
	{
		...
		Console::WordWrap(WINDOW_WIDTH / 4, WINDOW_HEIGHT / 2, WINDOW_WIDTH, "You Lose. Press 'R' to play again.");
	}
}
